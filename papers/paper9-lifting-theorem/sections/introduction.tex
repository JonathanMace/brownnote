...
equivalent-sphere singular limit through a quadratic onset
$\sigma_3(\varepsilon)=\lambda_1\varepsilon^2+O(\varepsilon^4)$ to a useful
oblate operating point, while the prolate branch remains poorly conditioned.  The lowest flexural resonance in that map is
