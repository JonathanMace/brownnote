...
branch the volume and wall thickness are fixed (see Section~2), with $a$
decreasing and $c$ increasing so that $a^2c=\text{const}$.  Across the tested
...
$\varepsilon>\num{0.2}$ (equivalently $\delta\gtrsim\num{0.02}$), where the
$\lambda_1\varepsilon^2$ term dominates and the artefact is negligible.

A least-squares fit of $\sigma_3(\delta)=\sigma_0+\lambda_1\delta^2$ to the
oblate data yields $\sigma_0=\num{0.0107}$ and $\lambda_1=\num{0.137}$; the
