...
$3.3 \times 10^4$ separating mechanical from airborne coupling efficiency for
...
displacement is \SI{0.028}{\micro\metre} (Table~\ref{tab:airborne}), roughly
...
requires approximately \SI{151}{\decibel}
...
displacement of \SI{0.028}{\micro\metre} at the same SPL.  For larger pockets
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcc}
    ...
    \hline
    Cavity resonance ($n{=}2$, airborne) & 0.028 & No \\
