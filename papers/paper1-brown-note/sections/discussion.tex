...
spatially uniform to within $(ka)^2$ corrections.  Although the air--tissue
interface reflects the vast majority of incident acoustic energy (intensity
transmission coefficient $T_I \approx 10^{-3}$), the small fraction of
pressure transmitted into the tissue may still drive local volume changes in
pre-existing gas pockets, which present a highly compliant inclusion within
the otherwise nearly incompressible abdominal fluid.  The gas pockets
therefore respond to the intracorporeal pressure field without the geometric
...
\begin{enumerate}
  ...
  \item \textbf{Free-shell boundary conditions.}  The abdomen is partially
    ...
    (\S\ref{sec:bc_effects}) is best understood as a \emph{boundary-condition
