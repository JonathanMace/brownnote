...
absolute prediction.  These boundary-condition frequency shifts are
illustrative; the two-degree-of-freedom Ritz basis provides upper bounds on
natural frequencies but has not been subjected to a formal convergence study.
The shifts should therefore be interpreted as order-of-magnitude estimates
rather than precise predictions.  The free-sphere Ritz frequency ($f_2 =
\SI{4.13}{\hertz}$) agrees
...
Within the limited resolution of the present Ritz basis, the frequency appears
relatively insensitive to boundary conditions.  A plausible physical reason is
...
constraint, the net effect is a frequency decrease.  We also note that reduced
2-DOF Ritz bases can carry several-percent sphere-limit bias; the exploratory
oblate calculation below shows a ${\sim}\,9\%$ offset, and comparable
discretisation error may also contribute here.
The illustrative \SI{6}{\percent} shift
