...
the epidemiological literature \cite{Griffin1990}, whereas airborne
...
vibration, the SDOF upper bound is $\mathcal{R}_\mathrm{full} \approx 3.3 \times 10^4$
($\Gamma_2 = 1$).  However, vertical base excitation does not couple
