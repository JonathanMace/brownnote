...
To interpret the biological relevance of this displacement, we compare it with
mechanotransduction thresholds.  PIEZO1 and PIEZO2 are mechanically activated
ion channels that convert membrane deformation into cellular signals; reported
activation begins for deformations of order
\SIrange{0.5}{2.0}{\micro\metre} \cite{coste2010piezo1}. 
...
\SIrange{0.5}{2.0}{\micro\metre} activation threshold.  (The pressure-based estimate of
