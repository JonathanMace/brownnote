...
\begin{table}[htbp]
  ...
  The pressure-based upper-bound estimate overestimates by a factor of ${\approx}\,6.5$
...
pressure-based upper-bound displacement of Table~\ref{tab:uq_summary}, which
