...
${\approx}\,13\times$ reduction from the pressure-based upper bound
...
energy-consistent result by approximately $13\times$; with the exact
...
${\sim}\,4$ above the energy-consistent value.
