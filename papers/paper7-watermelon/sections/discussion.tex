...
is approximately $\SI{155}{\hertz\squared\per\mega\pascal}$
\cite{MaceAndMace2026} when expressed in the same dimensionless
form---a striking similarity that reflects the common underlying
physics despite very different material scales.
