...
The shell--fluid framework used here is structurally identical to the
model applied to the human abdomen in our companion
work~\cite{MaceAndMace2026}, illustrating that classical shell
theory provides a common analytical basis for biological fluid-filled
structures across very different material scales.
