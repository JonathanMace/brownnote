...
the model applied to the human abdomen in our companion
work~\cite{MaceAndMace2026}; the governing equations are unchanged,
only the material parameters differ.
