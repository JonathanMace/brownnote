...
To verify that the inverse-problem quantities inherit this convergence, we
computed the condition number $\kappa$ using mode sets of increasing size:
...
For five or more modes, $\sigma_3$ varies by less than $6\%$, confirming that
the identifiability conclusions are not an artefact of the restricted basis.
