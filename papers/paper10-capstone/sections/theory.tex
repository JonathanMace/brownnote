...
Moreover, $\operatorname{rank}(\widetilde{J}_0)=2$ exactly, because at the
sphere the geometric sensitivity direction (uniform scaling of $R$) and the
material sensitivity direction ($E$) are linearly independent in the frequency
response --- changes in radius and changes in modulus produce spectrally
distinguishable effects.  Thus $\mu_3(0)=0$ is a simple eigenvalue of
