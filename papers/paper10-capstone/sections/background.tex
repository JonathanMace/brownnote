...
ratio of approximately $R \approx 3.3 \times 10^{4}$ (peak displacement
under whole-body vibration divided by peak displacement under airborne
excitation, for the same amplitude at the $n=2$ resonance)
between the two pathways~\cite{BrowntoneP1}.  The resonance was genuine, but the
