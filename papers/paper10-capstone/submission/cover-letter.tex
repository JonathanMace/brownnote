...
framework:
\begin{enumerate}
  \item \textbf{Theorem~1 (Rank Collapse).} Equivalent-radius reductions of
  ...
  \item \textbf{Theorem~2 (Identifiability Lifting).} Oblate asphericity lifts
