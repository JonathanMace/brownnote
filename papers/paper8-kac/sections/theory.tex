...
meridional curvature variation.  At $a = c$ the integrands become
$\eta$-independent and all expressions reduce to the equivalent-sphere
formulae of Section~\ref{sec:theory}.  For $a \neq c$, each mode
