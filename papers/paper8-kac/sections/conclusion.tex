...
\begin{enumerate}
  ...
  with curvature-channel floor $\sigma_0 = 0.01113$ and shape-channel
  coefficient $\lambda_1 = 0.00507$ (five modes); the crossover
  $\varepsilon_c = 1.48 > 1$ shows that the curvature channel dominates
  across the entire physical range, and the condition number saturates at
