...
\begin{enumerate}
  ...
  $\kappa_\mathrm{floor}\approx659$ (near-spherical) to $\kappa = 69.4$
  (canonical oblate), purely through geometric eccentricity;
  ...
  comparable to existing elastographic measurement precision;
