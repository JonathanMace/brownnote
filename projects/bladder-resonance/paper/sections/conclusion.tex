...
\begin{enumerate}
  \item The fundamental flexural mode ($n = 2$) lies between \SI{12}{\hertz}
    and \SI{18}{\hertz} for fill volumes of \SIrange{50}{500}{\milli\litre}.
    A frequency minimum of approximately \SI{12}{\hertz} occurs near
    \SI{170}{\milli\litre}, arising from the competition between geometric
  ...
  \item Mechanical vibration transmitted through the pelvic skeleton is
    approximately $7{,}600$ times more effective than airborne sound at
  ...
  \item The bladder's predicted resonance range (\SIrange{12}{18}{\hertz})
