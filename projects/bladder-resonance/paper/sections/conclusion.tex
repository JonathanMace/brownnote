...
\begin{enumerate}
  \item The fundamental flexural mode ($n = 2$) spans
    \SIrange{13.5}{17.1}{\hertz} for fill volumes of
    \SIrange{150}{500}{\milli\litre}
    where the thin-shell assumption is valid ($h/R < 0.1$).
    A frequency minimum of \SI{13.5}{\hertz} occurs at
  ...
  \item The bladder's predicted resonance range (\SIrange{13.5}{17.1}{\hertz})
...
bladder wall displacement is approximately \SI{47}{\micro\metre} at resonance
and \SI{160}{\micro\metre} in the sub-resonant regime---roughly three orders
of magnitude smaller than normal filling displacements, yet delivered at cyclic
