...
| E (Young's mod) | 10 kPa | 53 kPa | 200 kPa | Vibrometry data |
...
The **minimum f₂ ≈ 12 Hz** occurs near 150–200 mL due to competing effects:
...
|---------|----------|-----------|
| Airborne acoustic | (ka)² ≈ 1.0 × 10⁻⁴ | Pressure gradient across body |
| Mechanical (WBV) | ~0.8 | Seat → pelvis → bladder wall |
| **Mechanical advantage** | **~7,600×** | |

Whole-body vibration bypasses the (ka)^n acoustic penalty entirely.

### Interpretation

- The bladder n=2 mode (12–18 Hz) sits **above** the ISO 2631 peak pelvic
...
2. **Pelvic constraint** — ~40% of the bladder surface contacts the pelvic
   bone; a partial rigid boundary would modify the mode shapes and could
   lower the effective resonant frequency.
