...
the human abdomen as a fluid-filled shell using an equivalent-sphere
approximation and derived
closed-form expressions for its modal frequencies.  The watermelon
presents a structurally analogous problem---a thin elastic rind
enclosing a near-incompressible fluid---albeit with
