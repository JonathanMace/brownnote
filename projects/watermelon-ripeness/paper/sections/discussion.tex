...
ripeness parameter~$\Pi_{\mathrm{ripe}}$ is the fruit-domain analogue
...
$h$), and the dimensionless ripeness parameter~$\Pi_{\mathrm{ripe}}$
provides a natural framework for cross-species normalisation.
