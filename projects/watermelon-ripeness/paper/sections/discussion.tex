...
that can be approximated as an oblate spheroidal shell falls within its
...
$\mathcal{G}_2(\nu, \zeta)$, which is determined entirely by the
geometry and Poisson's ratio.  This positions the framework as a
