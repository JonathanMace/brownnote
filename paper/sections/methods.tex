...
axis $a = \SI{0.18}{\metre}$ and semi-minor axis $c = \SI{0.12}{\metre}$,
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    \midrule
    Young's modulus $E$ & \SIrange{50}{2000}{\kilo\pascal} & \citet{Fung1993} \\
    Poisson's ratio $\nu$ & 0.40--0.499 & Soft tissue \\
    Density $\rho_w$ & \SIrange{1000}{1200}{\kilogram\per\cubic\metre} & Tissue \\
    Sound speed $c_f$ & \SI{1470}{\metre\per\second} & Fluid \\
    Fluid density $\rho_f$ & \SI{1020}{\kilogram\per\cubic\metre} & Abdominal fluid \\
    \bottomrule
  \end{tabular}
\end{table}
