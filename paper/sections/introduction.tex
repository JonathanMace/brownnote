...
decades, surviving at least one televised debunking on \emph{MythBusters}~\cite{MythBusters2005BrownNote,Leventhall2007}.
...
The physics has a longer pedigree than the \emph{South Park} episode
``World Wide Recorder Concert'' (also known as ``The Brown Noise'') that
popularised the brown note~\cite{SouthPark2000BrownNoise}.  Gavreau's experiments at CNRS Levallois-Perret
...
$6.6 \times 10^4$ between mechanical and airborne pathways for
...
$\sim 3 \times 10^4$.  This single result---robust across physiologically
realistic parameter ranges, as we confirm through Monte Carlo uncertainty
quantification---resolves the empirical asymmetry cleanly.  It
