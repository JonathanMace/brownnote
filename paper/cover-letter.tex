...
to the fundamental flexural mode ($f_2 \approx \SI{3.95}{\hertz}$) is
approximately 46{,}000 times stronger than airborne acoustic coupling at
...
\begin{itemize}
  ...
  \item \textbf{Energy-consistent coupling analysis ($R \approx 46{,}000$).}
    ...
    routine occupational levels produces displacements $\sim$46{,}000 times
...
journal's scope.  The 46{,}000$\times$ coupling disparity also has
