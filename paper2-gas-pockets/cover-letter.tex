...
We are pleased to submit the enclosed manuscript, \emph{``Bowel Gas as an
Acoustic Transducer: A Constrained Bubble Model for Infrasound-Induced
Mechanotransduction in the Gastrointestinal Tract,''} for consideration as an
original research article in the \emph{Journal of the Acoustical Society of
America}.
...
\begin{itemize}
  ...
  \item A Monte Carlo population model ($N = 10\,000$) predicts that nearly
    all individuals exceed the \textsc{Piezo} threshold at
    \SI{120}{\decibel}, owing to the ubiquity of bowel gas.
\end{itemize}
