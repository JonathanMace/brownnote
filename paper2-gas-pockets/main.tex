...
evidence \citep{SouthPark2000BrownNoise,MythBusters2005BrownNote,Jauchem2007,Leventhall2007}.  Early aerospace-medicine
...
spherical frequencies are roughly 80--90\% of~$f_M$
...
The authors note that the second author's surname, while
serendipitous in the context of this research programme, was established
well before the project began and should not be taken as evidence of
predestination.

Analytical modelling, code development, figure generation, and manuscript
drafting were performed with the assistance of GitHub Copilot CLI
(GitHub, Inc.), a large language model.  The tool's contributions were
made under human supervision and are acknowledged here in accordance with
publisher guidelines regarding non-human contributors.
