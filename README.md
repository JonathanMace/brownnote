...
**Latest draft:** [`draft_2026-03-29_2231.pdf`](papers/paper8-kac/drafts/draft_2026-03-29_2231.pdf)  
**Key result:** within the Ritz model, eccentricity reduces the condition number from κ≈659 (near-spherical) to 69.4 (canonical oblate), with power-law scaling κ∼Cε⁻² confirmed numerically.
