...
%
\begin{equation}
  \xi_\mathrm{body} = T_\mathrm{body} \times \xi_\mathrm{floor},
  \quad
  \xi_\mathrm{floor} = \frac{v_\mathrm{floor}}{\omega},
  \quad
  v_\mathrm{floor} = \sqrt{\frac{\eta_f I A_f}{m_f \omega^2}},
...
$\eta_f \sim 0.01$ is the floor--acoustic coupling efficiency,
$A_f$ is the excited floor area, and $m_f$ is the floor mass per unit
area.  This is a simplified order-of-magnitude estimate; actual floor
vibration depends strongly on venue construction.
