...
This analysis suggests that the transcendent physical experience reported
during Bach's \emph{Toccata and Fugue in D minor} may owe as much to the
mechanical properties of oak pews as to the spiritual properties of the
composition---a conclusion that would doubtless have pleased the
instrument builder, if not the theologian.
