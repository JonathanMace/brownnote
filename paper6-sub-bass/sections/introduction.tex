...
concert sound pressure levels, and compare these with whole-body
vibration perception thresholds from ISO~2631-1~\cite{iso2631}.  Our
aim is to determine whether there exists a ``coupling transition band''
in which airborne acoustic excitation becomes non-negligible---or
whether the ``feel it in your gut'' experience at concerts is, like the
brown note itself, a phenomenon that cannot be explained by airborne
sound alone.
