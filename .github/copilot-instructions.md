...
| `reviewer-d` | Senior structural dynamicist — physical consistency, limit cases, transfer functions, presentation efficiency |
...
| Paper 9: Oblate-Prolate Asymmetry | JSV Short | Submission-ready (6pp) | 0 | ✅ | `papers/paper9-lifting-theorem/` |
| Paper 10: Capstone | Proc Roy Soc A | Submission-ready (26pp) | 0 | ⚠️ | `papers/paper10-capstone/` |
