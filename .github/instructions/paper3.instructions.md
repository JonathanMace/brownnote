...
2. **Create a timestamped draft snapshot**:
   ```powershell
   Copy-Item paper3-scaling-laws/main.pdf "paper3-scaling-laws/drafts/draft_$(Get-Date -Format 'yyyy-MM-dd_HHmm').pdf"
   ```
